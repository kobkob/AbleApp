use utf8;
package App::Able::Schema::Result::Verification;
...
=head1 TABLE: C<Verification>

=cut

__PACKAGE__->table("Verification");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:d9OW06hTdKdbGG0Y2ySSkw
