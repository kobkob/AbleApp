use utf8;
package App::Able::Schema::Result::Creation;
...
=head1 TABLE: C<Creation>

=cut

__PACKAGE__->table("Creation");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:i0x8AQaqpmv4nguIGOR73w
